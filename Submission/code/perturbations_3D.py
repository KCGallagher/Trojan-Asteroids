...
from constants import period, time_span, lagrange, greek_theta  # Derived constants
...
# width specification to ensure width values are also returned within properties
...
)  # to include best fit equation in legend
...
plt.legend()
plt.savefig("z_perturbations.png")
plt.show()
...
)  # Theoretical prediction is y = 2x as no wander beyond original perturbation
